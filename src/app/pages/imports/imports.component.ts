...
export class ImportsComponent implements OnInit {
  ...
  clearDatabase(): void {
    ...
    this.confirmation.confirm({
      title: 'Confirmar limpieza de base H2',
      message: '¿Desea limpiar todos los datos cargados?',
      detail: 'Esta acción eliminará la información cargada en la base H2 de pruebas. Para volver a consultar datos, deberá importar nuevamente el Excel.',
      confirmText: 'Limpiar base H2',
      tone: 'danger'
    }).subscribe(confirmed => {
      if (!confirmed) return;
