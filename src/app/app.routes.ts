...
import { CeroPapelPurchaseRequestsComponent } from './pages/ceropapel-purchase-requests/ceropapel-purchase-requests.component';
...
export const routes: Routes = [
  { path: 'login', component: LoginComponent },
  {
    ...
    children: [
      ...
      { path: 'solicitudes-compra', component: CeroPapelPurchaseRequestsComponent },
      ...
      },
      {
        path: 'usuarios',
        component: GenericMaintainerComponent,
        data: { config: { title: 'Usuarios', subtitle: 'Administración / Usuarios. Gestión de cuentas, roles, accesos, bloqueo, cambio de clave y trazabilidad de seguridad.', path: '/users', exportName: 'usuarios', searchPlaceholder: 'Buscar usuario', fields: [
          ...
          { key: 'roleIds', label: 'Roles', type: 'multiselect', required: true, optionsPath: '/roles', optionLabelKey: 'name', optionSecondaryKey: 'description', optionValueKey: 'id', tableValueKey: 'rolesText', placeholder: 'Buscar rol por nombre o descripción' },
          { key: 'lockedAt', label: 'Bloqueado', form: false },
          { key: 'lastLoginAt', label: 'Último acceso', form: false },
          { key: 'lastPasswordChangeAt', label: 'Último cambio clave', form: false }
        ] } }
      }
    ]
  }
